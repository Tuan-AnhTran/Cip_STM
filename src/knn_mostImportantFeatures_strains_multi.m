...
for i = 1:1000
    ...
    knn_model{i} = fitcknn(data_training, label_training, ...
                'Distance', 'cosine', 'NumNeighbors', 13);

    prediction_training = predict(knn_model{i}, data_training);
    ...
    prediction_validation = predict(knn_model{i}, data_validation);
    ...
    prediction_test = predict(knn_model{i}, data_test);
...
save ../results/result_knn_5features_strains_multi.mat