...
for i = 1:1000
    ...
    svm_model{i} = fitcsvm(data_training, label_training, ...
                'KernelFunction', 'polynomial', 'PolynomialOrder', 1);

    prediction_training = predict(svm_model{i}, data_training);
    ...
    prediction_validation = predict(svm_model{i}, data_validation);
    ...
    prediction_test = predict(svm_model{i}, data_test);
...
save ../results/result_SVM_5features_strains_multi.mat